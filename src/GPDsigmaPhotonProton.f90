module GPDsigmaPhotonProton  !Modulo sigma(photon+p --> photon+proton+J/Psi)
    use LI2mod
...
contains
    ...
    Subroutine  AmpPhotonProton(Amplitude)        
        real(8):: tmin, Amplitude
        real(8):: AmpIntReal, AmpIntImg
        tmin       = 1.d-7
